...
<body>
	...
	<form action="controller.QuestionInsert">
		<pre>
...
Answer:      <select name="answer">
             ...
             <input type="submit" value="Done"
				...
				onclick="location.href='AdminPanelPage'" value="Home"
				class="btn btn-outline-success">    <input type="button"
				onclick="location.href='all_questions'" value="Back"
				class="btn btn-outline-danger">
</pre>
	</form>
	<div>
	
		<font color="red"> <c:if test="${msg2  ne null}">
				<p>
					<c:out value="${msg2}" />
				<p>
			</c:if>
